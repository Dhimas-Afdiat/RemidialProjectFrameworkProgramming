        ...
        <div class="col-md-8">
          ...
          <div class="card mb-4 border shadow">
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title text-success">{{ $kendaraan->kendaraan_merk }}</h5>
                  ...
                  <a href="/homeawal/{{ $kendaraan->id }}/detail" class="btn btn-success">Baca Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Search Widget -->
          <div class="card my-4 border border-success shadow-lg">
            <h5 class="card-header bg-success text-dark" class="">VIDEO</h5>
            <video controls height="205px;" autoplay>
              <source src="{{asset('assets/images/otaku.mp4')}}" type="video/mp4">
            </video>
          </div>
          <div class="card my-4 border border-success shadow-lg">
            <h5 class="card-header bg-success text-dark">IKLAN</h5>
          ...
          <!-- Categories Widget -->
          <div class="card my-4 border border-success shadow-lg">
            <h5 class="card-header bg-success text-dark">LABEL</h5>
            <div class="inner">
              <div class="card-body">
                <a href=""><h5 class="card-title text-success">HOME</h5></a>
                <a href=""><h5 class="card-title text-success">MENU</h5></a>
                    <a href=""><h5 class="card-title text-success">ABOUT</h5></a>
                        <a href=""><h5 class="card-title text-success">PROFILE</h5></a>
              </div>
            </div>
